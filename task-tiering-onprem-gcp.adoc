...
* Für die Anmeldung über den GCP Marketplace: https://console.cloud.google.com/marketplace/details/netapp-cloudmanager/cloud-manager?supportedpurview=project&rif_reserved["Gehen Sie zum Cloud Manager Marketplace Angebot"^]Klicken Sie auf *Abonnieren*, und folgen Sie dann den Anweisungen.
